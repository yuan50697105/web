...
<body>
	...
	<div id="wrapper">
		<div class="box">
			<!-- 表单 -->
			<form id="productForm" action="${pageContext.request.contextPath }/product"
				method="post" enctype="multipart/form-data">
				<input type="hidden" name="method" value="save" />
				<table width="98%" class="tab">

					<tr align="left">
						<td>产品类型： <select name="type" id="newsType">
					...
					<tr>
						<td>产品图片:<input type="file" name="file" id="image">
						</td>
					</tr>
					<tr>
						<td>产品详情：<br /> <textarea name="content" id="content"></textarea>
						</td>
					</tr>
