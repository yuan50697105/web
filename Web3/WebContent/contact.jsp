...
<html>
	...
	<body>
		...
		<div class="banner">
			<a href="###"><img src="img/contect_banner.jpg" alt="banner3" /></a>
		</div>
		<div class="content clearfix">
			<div class="sidebar clearfix">
				...
				<ul>
					<li class="top">Detailed&ensp;address<br />And<br />Leaving&ensp;a&ensp;message</li>
					<li class="bottom">详细地址<br />给我们留言</li>
				</ul>
				<div class="search">
			...
			<div class="map" id="map" style="overflow: hidden; position: relative; z-index: 0; background-color: rgb(243, 241, 236); color: rgb(0, 0, 0); text-align: left;"></div>
			<div class="msg">
				<form action="">
					<h2>给我留言</h2>
					<div class="name">
					...
					<div class="code">
						...
						<img src="img/contect_code.jpg" alt="contect_code" />
					</div>
					<div class="button">
