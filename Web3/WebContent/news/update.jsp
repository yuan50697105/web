...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            /** 让类型下拉列表选中 */
            $("#typeSelect").val("${news.newsType.id}");
            /** 表单输入校验 */
    		$("#newsForm").submit(function() {
    			...
    			if ($.trim(title.val()) == "") {
    				msg = "标题不能为空！";
    				title.focus();
    			}else if(image.val().length==0||image.val()==null){
    				msg="图片不能为空";
...
<div id="wrapper">
    <div class="box">
        <!-- 表单 -->
        <form id="newsForm" action="${pageContext.request.contextPath }/news" method="post" enctype="multipart/form-data">
            ...
            <table width="98%" class="tab">
                ...
                <tr align="left">
                    <td>新闻类型：<select name="type" id="typeSelect">
                        <c:forEach items="${newsTypes }" var="nt">
                ...
                <tr align="left">
                    <td>新闻名称：<input type="text" name="title"
                                    value="${news.title }" size="30" id="title"/></td>
                </tr>
				<tr>
					<td>
						新闻图片：
                ...
                <tr>
                    <td>新闻内容：<br/> <textarea name="content" id="content">${news.content} </textarea>
                    </td>
                </tr>
