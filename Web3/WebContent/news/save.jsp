...
<!-- TinyMCE -->
<script src="${pageContext.request.contextPath}/js/tiny_mce/tiny_mce.js"></script>
<style>
#wrapper {
	width: 98%;
...
<body>
	...
	<div id="wrapper">
		<div class="box">
			<!-- 表单 -->
			<form id="newsForm" action="${pageContext.request.contextPath }/news"
				method="post" enctype="multipart/form-data">
				<input type="hidden" name="method" value="save" />
				<table width="98%" class="tab">

					<tr align="left">
						<td>新闻类型： <select name="type" id="newsType">
					...
					<tr>
						<td>新闻图片:<input type="file" name="file" id="image">
						</td>
					</tr>
					<tr>
						<td>新闻内容：<br /> <textarea name="content" id="content"></textarea>
						</td>
					</tr>
